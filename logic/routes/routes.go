...
var AllRoutes = func(router *mux.Router) {
	...
	router.HandleFunc("/patient/delete/{name}", Controller.DeletePatientByName).Methods("DELETE") //Leave method as GEt not DELETE -> the browser does an extra Preflight-Aufruf
